...
export const MOCK_REVIEWS_BY_PRODUCT_ID: Record<string, ProductReview[]> = {
  ...
  "prod-7": [
    buildReview("prod-7", 1, {
      ...
      rating: 5,
      title: "Si baja bastante los zancudos",
      body: "La pongo en la sala por las noches y se nota el cambio. Es silenciosa y facil de limpiar.",
      variant: "Blanco",
      days_ago: 4,
    }),
    buildReview("prod-7", 2, {
      ...
      body: "Me sirvio para el cuarto. Recomiendo ubicarla cerca de la ventana para mejor resultado.",
      variant: "Blanco",
      days_ago: 12,
    }),
  ],
  "prod-8": [
    buildReview("prod-8", 1, {
      ...
      rating: 5,
      title: "Buena succion para el carro",
    ...
    buildReview("prod-8", 2, {
      ...
      rating: 4,
      title: "Compacta y util",
      body: "Es liviana y se guarda facil. El deposito se limpia rapido y no ocupa espacio.",
      variant: "Unico",
      days_ago: 15,
    }),
  ],
  "prod-9": [
    buildReview("prod-9", 1, {
      ...
      rating: 5,
      title: "Me resolvio todos los cables",
      body: "Carga celular y accesorios sin llevar tantos cargadores. Muy practico para viaje.",
      variant: "Unico",
      days_ago: 7,
    }),
  ...
  "prod-10": [
    buildReview("prod-10", 1, {
      ...
      rating: 5,
      title: "Suave y facil de usar",
      body: "No irrita la piel y sirve bien para retoques rapidos en el rostro.",
      variant: "Unico",
      days_ago: 9,
    }),
    buildReview("prod-10", 2, {
      ...
      body: "Es pequeno y recargable. Me gustaron la luz y la brocha de limpieza.",
      variant: "Unico",
      days_ago: 21,
    }),
  ],
