...
export const PRODUCTS: Product[] = [
  ...
  {
    id: "prod-7",
    name: "Lámpara Mata Zancudos Eléctrica",
    slug: "lampara-mata-zancudos-electrica",
    description:
      "Lámpara UV para control de zancudos en espacios interiores. Atrae insectos voladores y los elimina con rejilla eléctrica interna, sin usar aerosoles ni olores fuertes. Ideal para habitaciones, salas y oficinas.",
    price: 65000,
  ...
  {
    id: "prod-8",
    name: "Aspiradora Inalámbrica de Mano 3 en 1",
    slug: "aspiradora-inalambrica-de-mano",
    description:
      "Aspiradora portátil inalámbrica para limpiar carro, oficina y hogar. Incluye boquilla ancha, boquilla cepillo y boquilla plana para residuos finos y rincones. Depósito desmontable de fácil limpieza y batería recargable para uso diario.",
    price: 89900,
    ...
    is_active: true,
    is_bestseller: false,
    meta_title: "Aspiradora Inalámbrica de Mano | Limpieza Rápida 3 en 1",
    meta_description:
      "Aspiradora de mano recargable para hogar y carro, con accesorios 3 en 1, diseño compacto y envío gratis.",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    id: "prod-9",
    name: "Combo Cargador 4 En 1 Adaptador cable",
    slug: "combo-cargador-4-en-1-adaptadorcable",
    description:
      "Combo de cargador y cable multifuncional 4 en 1 compatible con USB Tipo C, Tipo A y Lightning. Facilita carga rápida y sincronización de datos en un solo accesorio resistente, ideal para casa, oficina o viajes.",
    price: 69900,
    ...
    is_active: true,
    is_bestseller: false,
    meta_title: "Combo Cargador 4 en 1 | Carga Rápida Multi Puerto",
    meta_description:
      "Combo cargador 4 en 1 con adaptador cable para USB-C, USB-A y Lightning. Carga rápida y envío gratis nacional.",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    id: "prod-10",
    name: "Depilador Facial Eléctrico Recargable",
    slug: "depilador-facial-electrico-recargable",
    description:
      "Depilador facial eléctrico tipo labial para eliminar vello facial y corporal de forma suave. Incluye luz integrada para mayor precisión y diseño compacto ideal para llevar en bolso o viaje.",
    price: 44900,
    ...
    is_active: true,
    is_bestseller: false,
    meta_title: "Depilador Facial Eléctrico Recargable | Portátil",
    meta_description:
      "Depilador facial recargable, compacto y fácil de usar para retoques diarios. Envío gratis y pago contra entrega.",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
];
