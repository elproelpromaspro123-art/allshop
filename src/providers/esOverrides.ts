export const ES_OVERRIDES: Record<string, string> = {
  ...
  "social.badgeShipping": "Envío nacional a toda Colombia",
  ...
  "assistant.deepModeHint":
    "Actívalo cuando quieras que el asistente navegue sin pedir permiso cada vez.",
  "assistant.agentModeTitle": "Modo agente",
  "assistant.agentModeHint":
    "Con modo agente apagado, el asistente te pide permiso antes de moverte por la página. Si lo activas, navega solo y puede investigar más a fondo.",
  "assistant.actionApprove": "Permitir acción",
  "assistant.actionActivateAgent": "Activar modo agente",
  "assistant.actionAutoMode": "Modo agente activo",
  "assistant.actionExecuted": "Acción ejecutada",
  "assistant.actionRunAgain": "Ir de nuevo",
