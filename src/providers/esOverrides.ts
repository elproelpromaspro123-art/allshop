export const ES_OVERRIDES: Record<string, string> = {
  "category.noProducts":
    "Por ahora no tenemos productos para esta categoría. Estamos preparando nuevos lanzamientos.",
  "categories.subtitle":
  ...
  "commitment.shippingTitle": "Entrega clara y realista",
  ...
  "header.freeShipping": "Envío a todo Colombia",
  ...
  "policy.faq.q4": "¿Cómo solicito soporte?",
  "policy.privacy.metaDescription":
    "Cómo tratamos y protegemos tus datos personales en Vortixy.",
  "policy.privacy.subtitle":
    "Usamos tu información solo para procesar tu compra, coordinar tu entrega y atender soporte.",
  "policy.returns.eligibility1":
    "El producto debe conservarse en buen estado y sin uso indebido.",
  "policy.returns.eligibility2":
    "Debe incluir empaque y accesorios originales cuando aplique.",
  "policy.returns.eligibility3":
    "Debe presentarse el comprobante de compra o referencia del pedido.",
  "policy.returns.eligibilityTitle": "Condiciones para aplicar garantía",
  "policy.returns.metaDescription":
    "Condiciones de cambios, garantía y devoluciones según el producto comprado.",
  "policy.returns.nonEligible1":
    "No aplica en daños por uso inadecuado o manipulación incorrecta.",
  "policy.returns.nonEligible2":
    "No aplica cuando falten piezas incluidas originalmente.",
  "policy.returns.nonEligibleTitle": "Casos que no aplican",
  ...
  "policy.terms.liabilityText":
    "Respondemos por la gestión correcta del pedido en nuestra plataforma. Factores externos de transporte pueden afectar tiempos de entrega.",
  ...
  "social.ogBrandLine": "Tu tienda online en Colombia",
  ...
  "assistant.open": "Abrir asistente Vortixy",
  "assistant.expand": "Expandir asistente",
  ...
  "assistant.deepModeOn": "Modo profundo activo",
  "assistant.deepModeOff": "Modo profundo opcional",
  "assistant.newChat": "Nueva charla",
  "assistant.welcomeEyebrow": "Asistencia en tiempo real",
  "assistant.welcomeTitle": "Pregúntame por productos, pagos, envíos o soporte.",
  "assistant.welcomeBody":
    "Primero investigo en la web y reviso páginas relevantes para responder con más contexto y menos ruido.",
  "assistant.featureResearchTitle": "Investiga antes de responder",
  "assistant.featureResearchBody": "Busca en vivo y contrasta páginas antes de darte una respuesta.",
  "assistant.featureClarityTitle": "Ordena lo importante",
  "assistant.featureClarityBody": "Resume lo esencial, compara opciones y evita saturarte de información.",
  ...
  "assistant.promptCompareProduct": "Compáralo con otra opción conveniente",
  "assistant.promptDelivery": "Qué debo esperar de entrega y seguimiento",
  ...
  "assistant.placeholder": "Escribe tu duda. Yo me encargo de investigar y ordenarte la respuesta.",
  "assistant.send": "Enviar mensaje",
  "assistant.deepMode": "Modo profundo",
  "assistant.deepModeTitle": "Exploración profunda",
  "assistant.deepModeEnabled": "Activo",
  "assistant.deepModeDisabled": "Opcional",
  "assistant.deepModeHint":
    "Actívala solo cuando quieras revisiones interactivas más profundas y navegación guiada en casos donde sí haga falta.",
  "assistant.tools": "Acciones usadas",
  "assistant.sources": "Fuentes revisadas",
  "assistant.loadingTitle": "Investigando",
  "assistant.loadingSearch": "Buscando en la web en modo avanzado.",
  "assistant.loadingVisit": "Revisando páginas relevantes antes de responder.",
  "assistant.loadingAnswer": "Ordenando la mejor respuesta para ti.",
