...
const ES_TRANSLATIONS: TranslationMap = {
  ...
  "header.freeShipping": "Envío nacional disponible",
  ...
  "policy.privacy.retentionText": "Conservamos tus datos personales durante el tiempo necesario para los fines para los que fueron recopilados, incluyendo la cumplimiento de obligaciones legales, resolver disputas y hacer cumplir nuestros acuerdos. Los datos de pedidos se conservan por 5 años. Los datos de cuenta se eliminan a solicitud del titular.",
  ...
  "productCard.international": "Despacho nacional",
  "productCard.internationalDispatch": "Despacho nacional",
  ...
  "announcement.cod": "Pago contra entrega",
  ...
  "order.cod.step1.text": "Tu pedido ya fue registrado exitosamente",
  "order.cod.step2.title": "Envío a tu puerta",
  "order.cod.step2.text": "Te enviaremos el producto a la dirección indicada",
  "order.cod.step3.title": "Pagas al recibir",
  "order.cod.step3.text": "Solo pagas cuando el producto llegue a tus manos",
  ...
  "product.estimateRange": "Rango estimado en calendario:",
  ...
  "product.nationalShipping": "Envío nacional",
