...
const ES_TRANSLATIONS: TranslationMap = {
  ...
  "cta.subtitle": "Explora un catalogo actualizado para Colombia con contra entrega y soporte real.",
  ...
  "footer.description": "Tienda online enfocada en Colombia con despacho nacional y atencion personalizada.",
  ...
  "header.freeShipping": "Envio nacional disponible",
  ...
  "policy.faq.a2": "Tu pedido se confirma al finalizar checkout y pasa a gestion logistica.",
  "policy.faq.a3": "Por ahora realizamos envios unicamente dentro de Colombia.",
  ...
  "policy.shipping.coverageText": "Realizamos envios en todo el territorio colombiano. La disponibilidad se valida al confirmar direccion.",
  ...
  "policy.shipping.metaDescription": "Cobertura nacional, tiempos estimados y costos de envio en Colombia.",
  "policy.shipping.subtitle": "Operamos despachos nacionales con estimaciones realistas por ciudad y departamento.",
  "policy.shipping.timesInternational": "No realizamos envios internacionales por el momento.",
  ...
  "policy.tracking.how2": "Consulta el estado en esta pagina con tu correo y telefono.",
  ...
  "policy.tracking.times1": "La confirmacion del pedido es inmediata despues del checkout.",
  "policy.tracking.times2": "La revision manual y alistamiento suelen tomar hasta 24 horas habiles.",
  ...
  "shipping.internationalLabel": "Envio nacional",
