...
const BASE_ES_TRANSLATIONS: TranslationMap = {
  ...
  "checkout.savedProfileDescription":
    "Último uso: {date}. Puedes ajustar estos datos antes de confirmar.",
  "checkout.savedProfileFallbackDate": "hace poco",
  "checkout.savedProfileTitle":
    "Precargamos tu último contacto y tu última dirección.",
  ...
  "checkout.forgetSavedProfile": "Olvidar estos datos",
