  ...
  "group/button relative inline-flex items-center justify-center gap-2 whitespace-nowrap font-semibold transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-emerald-500/20 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer overflow-hidden",
  {
    variants: {
      variant: {
        ...
        soft: "rounded-full border border-emerald-500/12 bg-emerald-50 text-emerald-700 shadow-[0_10px_28px_rgba(16,185,129,0.08)] hover:bg-emerald-500/15 hover:border-emerald-500/20 active:scale-[0.99] focus-visible:ring-emerald-500/20",
        link: "rounded-none border-none bg-transparent text-emerald-700 underline-offset-4 hover:underline hover:text-emerald-600 p-0 h-auto focus-visible:ring-emerald-500",
      },
      size: {
