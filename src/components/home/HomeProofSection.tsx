          ...
          <div className="v-editorial-copy">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
                Antes de comprar necesitas saber tres cosas: cuánto cuesta,
                cuándo llega y qué pasa si algo sale mal. Acá tenés las tres respuestas en un solo lugar.
              </p>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-[1.6rem] border border-slate-200/80 bg-white/88 px-5 py-5 shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
                ...
                <p className="mt-3 text-lg font-bold tracking-tight text-slate-950">
                  Precios y tiempos reales, no promesas vacías.
                </p>
                <p className="mt-2 text-sm leading-7 text-slate-600">
                  Lo que ves en la página es lo que pagas. Sin cargos ocultos ni sorpresas al momento de la entrega.
                </p>
              </div>
              ...
              <div className="rounded-[1.6rem] border border-slate-200/80 bg-slate-950 px-5 py-5 text-white shadow-[0_22px_70px_rgba(2,6,23,0.18)]">
                ...
                <p className="mt-2 text-sm leading-7 text-white/74">
                  Una persona responde tus dudas en minutos. Antes de comprar, durante el envío o después de recibir.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              >
                <Link href="/faq">Ver garantías</Link>
              </Button>
            </div>
          </div>
