  ...
  const values = [
    {
      ...
      description:
        "No necesitas tarjeta. Pagas en efectivo cuando te llega el paquete.",
    },
    {
      icon: Truck,
    ...
    },
    {
      ...
      description:
        "Si algo sale mal, lo solucionamos. Así de simple.",
    },
    {
      icon: RotateCcw,
      title: "Cambios y devoluciones",
      description:
        "Tienes 5 días para pedir un cambio o devolución si algo no te convence.",
    },
    {
      icon: Headphones,
      ...
      <div className="v-section-inner">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">
            ¿Por qué comprar en Vortixy?
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
            Todo está pensado para que compres tranquilo, sin sorpresas
