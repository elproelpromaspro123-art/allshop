...
-- 2) Reubicar resenas de slugs viejos hacia los slugs canonicos nuevos
WITH product_map AS (
...
-- 3) Aprobar compras verificadas de los productos canonicos
UPDATE product_reviews pr
...
-- 4) Seed de stock operativo manual para panel privado + checkout
