-- ============================================
-- Vortixy / Allshop - CANONICAL SUPABASE SCRIPT
-- Fecha: 2026-03-21
-- Orden recomendado:
-- 1) Ejecutar unicamente este archivo completo en Supabase SQL Editor
-- ============================================

-- Este archivo es la unica fuente SQL canonica.
-- Incluye esquema, seguridad, catalogo, stock operativo y resenas semilla.
-- ============================================
-- Allshop / Vortixy - esquema principal
...
-- ============================================
-- Allshop / Vortixy - catálogo canónico
  ...
  FROM (
    VALUES
      (
        ...
        'Audífonos in-ear con cancelación activa de ruido, audio espacial, modo ambiente y batería de hasta 30 horas para uso diario.',
        160000,
        229000,
        'tecnologia',
        ARRAY[
        ...
        true,
        'AirPods Pro 3 con Cancelación de Ruido',
        'AirPods Pro 3 con cancelación activa de ruido, audio espacial, modo ambiente y envío gratis.'
      ),
      (
...
-- ============================================
-- Allshop / Vortixy - stock operativo
...
-- ============================================
-- Allshop / Vortixy - 04_seed_product_reviews.sql
-- Rese?as semilla reejecutables sin duplicados
-- ============================================

BEGIN;

WITH ranked_seed_reviews AS (
  SELECT
    id,
    ROW_NUMBER() OVER (
      PARTITION BY product_id, COALESCE(reviewer_name, ''), COALESCE(title, ''), body
...
-- ============================================
-- Allshop / Vortixy - reseñas semilla
